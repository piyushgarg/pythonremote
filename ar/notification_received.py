...
def notification_received(received):
    ...
    if sys.platform.startswith('linux'):
        ...
        # Mac OS X
        notifi = ["terminal-notifier", "-title", received["title"], "-subtitle", "Pythonremote by Storvik", "-message",
                  received["text"], "-appIcon",
                  "https://lh5.ggpht.com/fQGeFGOUahclDOUsKU0d6F-Odg9D2jUB7xVnrH5KdeV1m8TcX_wdkbHTvKY2ZoIMgWj2=w300"]
        if "icon" in received:
